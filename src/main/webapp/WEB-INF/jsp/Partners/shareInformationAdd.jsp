...
<article class="page-container">
    <form action="/DascomBack/shareInfoSubmit/add" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
       
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>资料名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  placeholder="请输入资料名称" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
