...
<div class="page-container">
	<form action="/DascomBack/productSumbbitEdit" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
         <div class="row cl">
       ...
       <div class="row cl" style="color: gray;margin-left: 105px">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${product.pname }" placeholder="请输入产品名称" id="name" name="name">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea cols="100" rows="10" name="description" class="ckeditor" id="description" placeholder="请输入产品描述">${product.pintroduce }</textarea>
            </div>
        </div>
        <div class="row cl">
