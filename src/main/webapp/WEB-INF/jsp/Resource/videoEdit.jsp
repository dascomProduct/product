...
<article class="page-container">
    <form action="/DascomBack/videoSubmit/edit" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
        <input type="hidden" name="pvid" value="${video.pvid}">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>视频名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="请输入视频名称" id="username" name="name" value="${video.pvname}">
            </div>
        </div>   
