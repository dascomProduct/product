...
<article class="page-container">
    <form action="/DascomBack/downloadSubmit/edit" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
       <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>资源分类：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
             <input type="hidden" name="id" value="${software.sid} ">
                <input type="text" class="input-text"  placeholder="请输入资源名称" id="name" name="name" value="${software.sname} ">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>资源文件：</label>
